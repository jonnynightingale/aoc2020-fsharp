...
type Problem = {
    dayNumber : int
    filename : string
    solve : string array -> uint64 * uint64
}
...
let problems = [
    ...
    { dayNumber = 10; filename = @"../../../../input/day10.txt"; solve = Day10.Solve }
    { dayNumber = 11; filename = @"../../../../input/day11.txt"; solve = Day11.Solve }
    { dayNumber = 12; filename = @"../../../../input/day12.txt"; solve = Day12.Solve }
    { dayNumber = 13; filename = @"../../../../input/day13.txt"; solve = Day13.Solve }
    { dayNumber = 14; filename = @"../../../../input/day14.txt"; solve = Day14.Solve }
    { dayNumber = 15; filename = @"../../../../input/day15.txt"; solve = Day15.Solve }
    { dayNumber = 16; filename = @"../../../../input/day16.txt"; solve = Day16.Solve }
]
